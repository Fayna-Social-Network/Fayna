<template>
  <div class="send-message-panel" :class="{ 'bg-dark': $q.dark.isActive }">
    <div class="button-contol">
      <q-btn round color="primary" icon="mood" :size="iconSize">
        <StickerBox @onSelectSticker="onSelectSticker" @selectEmoji="selectEmoji" />
      </q-btn>
    ...
    <div class="message-input" @keydown.enter="sendMessageHandle">
      <q-input filled v-model="message" :placeholder="$t('SendMessageInputPlaceholder')" />
    </div>
    <div class="button-contol">
...
import MicButton from "src/modules/MessageSender/components/MicButton.vue";
import MenuMessage from 'src/modules/MessageSender/components/MessageComponentMenu.vue'
import StickerBox from 'src/modules/Stickers/components/StickersBoxComponent.vue'
