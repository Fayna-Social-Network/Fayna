<template>
  ...
  <q-form @submit="onSubmit" @reset="onReset" class="q-gutter-md">
    <q-input filled v-model="firstname" label="Your name *" hint="Please enter your name" lazy-rules
      :rules="[val => val && val.length > 0 || 'Please type something']" />
    <q-input filled v-model="lastname" label="Your lastname *" hint="Please enter your lastname" lazy-rules
      :rules="[val => val && val.length > 0 || 'Please type something']" />
    <q-input v-model="(avatar as string)" filled accept="image/png, image/gif, image/jpeg" type="file"
