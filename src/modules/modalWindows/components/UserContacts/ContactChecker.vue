<template>
  <DialogModal>
    ...
    <template #body>
      <q-list>
        <q-item v-ripple v-for="contact in listContacts" :key="contact.contactId">
          <q-item-section>
            <Contact :user='contact' @checkUser='checkUser' />
          </q-item-section>
        </q-item>
      </q-list>
    </template>
...
import Contact from 'src/modules/Users/components/UserAndContacts/ContactChecker.vue'
...
import { forwardMessage } from 'src/modules/Message/services/messager'
