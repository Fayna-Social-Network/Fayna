<template>
  <DialogModal>
      ...
      <div class="stickers-groups" @click="bodyClickHandle()">
        <div class="list-block">
          <ul class="groups-list">
            <li class="group-item" v-for="group in stikerGroup" :key="group.id"
    ...
    <template #actions>
      <q-btn color="primary" icon="add" :label="$t('Add')" v-if="isNormal" @click="addGroupHandle" />
      <q-btn color="negative" icon="delete" :label="$t('DeleteStickerGroup')" v-else @click="delGroupHandle" />
...
import Stickers from "src/modules/Stickers/services/sticker.service"
