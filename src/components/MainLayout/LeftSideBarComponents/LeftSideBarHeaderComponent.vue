    ...
    <div class="theme-title">
      <div class="header">
        ...
        <div class="header-button">
          <q-btn round color="primary" icon="search" @click.stop="searchActivateHandler(true)">
      ...
      <transition appear enter-active-class="animated zoomIn" leave-active-class="animated zooOut">
        <div v-show="activeSearch" class="search-form">
          <q-input v-model="searchInputText" :placeholder="$t('SearchPlaceholder')" input-style="color: white;">
            <template v-slot:prepend>
              <q-icon name="alternate_email" />
            </template>
            <template v-slot:append>
              <q-icon name="close" @click.stop="searchActivateHandler(false)" style="cursor: pointer;" />
            </template>
          </q-input>
        </div>
      </transition>
